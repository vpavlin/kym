...
// KYM budget grid. Renders entirely off the backend's folded budgetJson PROP —
// no state in the view. Plain QtQuick so it renders in any Basecamp theme.
Item {
    id: root
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    Text { text: (budget.currentMonth || "") + "  ·  " + status; color: dim; font.pixelSize: 12 }
                }
                ...
                ColumnLayout {
                    ...
                    Repeater {
                        ...
                        delegate: ColumnLayout {
                            ...
                            spacing: 0
                            Text {
                                text: modelData.name; color: accent; font.pixelSize: 13; font.bold: true
                    ...
                    Text {
                        ...
                        text: "Credit Card Payments"; color: accent; font.pixelSize: 13; font.bold: true
                    ...
                    // ---- accounts ----
                    Text {
                        text: "Accounts"; color: accent; font.pixelSize: 13; font.bold: true
                        topPadding: 12; bottomPadding: 4
                    }
                    Repeater {
